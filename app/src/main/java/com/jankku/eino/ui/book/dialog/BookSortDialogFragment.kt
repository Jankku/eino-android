...
import com.jankku.eino.databinding.FragmentSortBookDialogBinding
import com.jankku.eino.ui.book.BookViewModel
import dagger.hilt.android.AndroidEntryPoint

private const val TAG = "BookSortDialogFragment"

@AndroidEntryPoint
class BookSortDialogFragment : BottomSheetDialogFragment() {
    private var _binding: FragmentSortBookDialogBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSortBookDialogBinding.inflate(inflater)
        return binding.root
    }
    ...
    private fun setupOnChangeListeners() {
        ...
        binding.rgStatus.setOnCheckedChangeListener { group, index ->
            val item = group.findViewById<RadioButton>(index)
            val statusIndex = group.indexOfChild(item)
            val status = BookStatus.values()[statusIndex]
